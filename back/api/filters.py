...
class ContratoFilter(django_filters.FilterSet):
    data_inicio = django_filters.DateFilter(field_name="data_inicio", lookup_expr="icontains")
    data_fim = django_filters.DateFilter(field_name="data_fim", lookup_expr="icontains")
...
class PagamentoFilter(django_filters.FilterSet):
    data_pagamento = django_filters.DateFilter(field_name="data_pagamento", lookup_expr="icontains")
    valor_max = django_filters.NumberFilter(field_name="valor", lookup_expr="lte")
    valor_min = django_filters.NumberFilter(field_name="valor", lookup_expr="gte")
    ...
    class Meta: 
        model = Pagamento
        fields = ['data_pagamento', 'valor', 'status']
